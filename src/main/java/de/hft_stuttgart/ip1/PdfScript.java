...
public class PdfScript {
    ...
    public void setOut(Path p) { out = p; }
    ...
    public void moveCursor(float dx, float dy) { cursorX += dx; cursorY += dy; }
    ...
    public static Color parseColor(String token) {
        ...
        try { return (Color) Color.class.getField(t.toUpperCase(Locale.ROOT)).get(null); } catch (Exception ignored) {}
        return Color.BLACK;
    }
